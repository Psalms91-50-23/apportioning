        ...
        <div className="flex flex-row relative w-full"
         ...
         >
          <input
            ...
            ref={inputRef}
            onBlur={onBlur}
            className={`border-4 focus:border-4 focus:border-black-900 no-select no-drag w-full border rounded-lg py-2 px-3 pr-12 font-bold text-black-900 ${error ? ' border-red-500' : 'border-transparent'}`}
